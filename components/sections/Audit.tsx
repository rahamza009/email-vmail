    ...
    <section id="audit" className="py-20 md:py-28 px-6 bg-white">
      <div className="max-w-3xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="font-inter text-gray-500 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
            Get your{" "}
            <strong className="text-gray-800">$0 Audit Report</strong> delivered
            in 7 days. No commitment. No fluff. Just a clear picture of what
            your email list is leaving on the table.
          </p>
